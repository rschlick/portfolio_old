...
angular.module('portfolioApp')
  .controller('MainCtrl',['$rootScope','$scope' ,function ($rootScope, $scope) {
    ...
    {"title": "Consultant Java JEE Senior", "place":"Xebia", "years":"2014 - 2015", "description": "J'ai effectué des missions à forte technicité dans l'écosystème Java JEE / Spring et dans des environnements le plus souvent agile (scrum/kanban)."},
